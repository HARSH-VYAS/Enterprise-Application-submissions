...
public class Client {
    ...
    public static void write() throws Exception {       
        ...
        if (DistributedCacheService.successCount.intValue() < 2) {	        	
        	...
        	cache3.get(key);
        	Thread.sleep(1000);
        	System.out.println("Result from Server 1 is: " + cache1.getValue());
    	    System.out.println("Result from Server 2 is: " + cache2.getValue());
    	    System.out.println("Result from Server 3 is: " + cache3.getValue());
        }
